...
func TestLambdaLabsClient_GetInstanceTypes_Success(t *testing.T) {
	...
	instanceTypes, err := client.GetInstanceTypes(context.Background(), cloud.GetInstanceTypeArgs{})
...
func TestLambdaLabsClient_GetInstanceTypes_FilterByLocation(t *testing.T) {
	...
	instanceTypes, err := client.GetInstanceTypes(context.Background(), cloud.GetInstanceTypeArgs{
		Locations: cloud.LocationsFilter{"us-west-1"},
	})
	require.NoError(t, err)
...
func TestLambdaLabsClient_GetInstanceTypes_FilterBoth(t *testing.T) {
	...
	instanceTypes, err := client.GetInstanceTypes(context.Background(), cloud.GetInstanceTypeArgs{
		Locations:     cloud.LocationsFilter{"us-east-1"},
...
func TestLambdaLabsClient_GetInstanceTypes_Error(t *testing.T) {
	...
	_, err := client.GetInstanceTypes(context.Background(), cloud.GetInstanceTypeArgs{})
	assert.Error(t, err)
}
...
func findInstanceTypeByName(instanceTypes []cloud.InstanceType, name string) *cloud.InstanceType {
	for _, instanceType := range instanceTypes {
