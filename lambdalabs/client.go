...
var _ cloud.CloudClient = &LambdaLabsClient{}
...
func (c *LambdaLabsClient) GetAPIType() cloud.APIType {
	return cloud.APITypeGlobal // Lambda Labs uses a global API
}

// GetCloudProviderID returns the cloud provider ID for Lambda Labs
func (c *LambdaLabsClient) GetCloudProviderID() cloud.CloudProviderID {
	return CloudProviderID
}

// MakeClient creates a new client instance
func (c *LambdaLabsClient) MakeClient(_ context.Context, location string) (cloud.CloudClient, error) {
	if location == "" {
