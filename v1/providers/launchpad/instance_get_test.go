...
func TestLaunchpadClient_GetInstances(t *testing.T) {
	t.Parallel()
	checkSkip(t)
	apiKey := getAPIKey()
	...
	instances, err := client.GetInstance(context.Background(), v1.CloudProviderInstanceID("1f507fb0-a90e-4d9e-89da-1ccd6abe4ce1"))
