...
type Deployment struct {
	...
	Experience *DeploymentExperience `json:"experience,omitempty"`
...
func (o *Deployment) SetCatalogIdAliasNil() {
...
// SetExperience gets a reference to the given DeploymentExperience and assigns it to the Experience field.
