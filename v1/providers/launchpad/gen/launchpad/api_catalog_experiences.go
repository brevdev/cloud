...
func (r ApiV1CatalogExperiencesListRequest) Featured(featured bool) ApiV1CatalogExperiencesListRequest {
	r.featured = &featured
	return r
}
...
func (r ApiV1CatalogExperiencesListRequest) Oem(oem string) ApiV1CatalogExperiencesListRequest {
	r.oem = &oem
	return r
}
...
func (r ApiV1CatalogExperiencesListRequest) Runtime(runtime string) ApiV1CatalogExperiencesListRequest {
	r.runtime = &runtime
	return r
}
...
// Search for experiences by assignee, catalog_id, catalog_id_alias, category, collection_branch, description, experience, experience_branch, gc_branch, gpu_os_name, gpu_os_release, gpu_os_version, id, oem name, persona, pipeline, platform, provider name, required_gpus model, runtime name, system_arch, title, vgpu_profile
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesCreate(ctx context.Context, experienceId string) ApiV1CatalogExperiencesNotesCreateRequest {
	return ApiV1CatalogExperiencesNotesCreateRequest{
		ApiService:   a,
		ctx:          ctx,
...
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesCreateExecute(r ApiV1CatalogExperiencesNotesCreateRequest) (*ExperienceNote, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesDestroy(ctx context.Context, experienceId string, id string) ApiV1CatalogExperiencesNotesDestroyRequest {
	return ApiV1CatalogExperiencesNotesDestroyRequest{
		ApiService:   a,
		ctx:          ctx,
		experienceId: experienceId,
...
// Execute executes the request
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesDestroyExecute(r ApiV1CatalogExperiencesNotesDestroyRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesList(ctx context.Context, experienceId string) ApiV1CatalogExperiencesNotesListRequest {
	return ApiV1CatalogExperiencesNotesListRequest{
		ApiService:   a,
		ctx:          ctx,
		experienceId: experienceId,
...
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesListExecute(r ApiV1CatalogExperiencesNotesListRequest) (*PaginatedExperienceNoteList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesPartialUpdate(ctx context.Context, experienceId string, id string) ApiV1CatalogExperiencesNotesPartialUpdateRequest {
	return ApiV1CatalogExperiencesNotesPartialUpdateRequest{
		ApiService:   a,
		ctx:          ctx,
		experienceId: experienceId,
...
//
//	@return ExperienceNote
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesPartialUpdateExecute(r ApiV1CatalogExperiencesNotesPartialUpdateRequest) (*ExperienceNote, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesPartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesRetrieve(ctx context.Context, experienceId string, id string) ApiV1CatalogExperiencesNotesRetrieveRequest {
	return ApiV1CatalogExperiencesNotesRetrieveRequest{
		ApiService:   a,
		ctx:          ctx,
		experienceId: experienceId,
...
//
//	@return ExperienceNote
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesRetrieveExecute(r ApiV1CatalogExperiencesNotesRetrieveRequest) (*ExperienceNote, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesRetrieve")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesUpdate(ctx context.Context, experienceId string, id string) ApiV1CatalogExperiencesNotesUpdateRequest {
	return ApiV1CatalogExperiencesNotesUpdateRequest{
		ApiService:   a,
		ctx:          ctx,
		experienceId: experienceId,
...
//
//	@return ExperienceNote
func (a *CatalogExperiencesAPIService) V1CatalogExperiencesNotesUpdateExecute(r ApiV1CatalogExperiencesNotesUpdateRequest) (*ExperienceNote, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogExperiencesAPIService.V1CatalogExperiencesNotesUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
/*
V1CatalogExperiencesStatsRetrieve 🚧 [Beta Feature]
