...
// checks if the NodeBulkUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeBulkUpdate{}

// NodeBulkUpdate struct for NodeBulkUpdate
type NodeBulkUpdate struct {
...
type _NodeBulkUpdate NodeBulkUpdate
...
func (o *NodeBulkUpdate) SetBmcIpNil() {
	o.BmcIp.Set(nil)
}
...
func (o *NodeBulkUpdate) SetBmcMacNil() {
	o.BmcMac.Set(nil)
}
...
func (o *NodeBulkUpdate) SetBmcPasswordNil() {
...
func (o *NodeBulkUpdate) SetBmcUserNil() {
	o.BmcUser.Set(nil)
}
...
func (o *NodeBulkUpdate) SetClusterNil() {
	o.Cluster.Set(nil)
}
...
func (o *NodeBulkUpdate) SetCpuManufacturerNil() {
...
func (o *NodeBulkUpdate) SetCpuModelNil() {
	o.CpuModel.Set(nil)
}
...
func (o *NodeBulkUpdate) SetGarageIdNil() {
	o.GarageId.Set(nil)
}
...
func (o *NodeBulkUpdate) SetGpuVbiosNil() {
	o.GpuVbios.Set(nil)
}
...
func (o *NodeBulkUpdate) SetMgmtMacNil() {
	o.MgmtMac.Set(nil)
}
...
func (o *NodeBulkUpdate) SetModelNil() {
	o.Model.Set(nil)
}
...
func (o *NodeBulkUpdate) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *NodeBulkUpdate) SetOemNil() {
	o.Oem.Set(nil)
}
...
func (o *NodeBulkUpdate) SetProviderNodeIdNil() {
...
func (o *NodeBulkUpdate) SetRackNil() {
	o.Rack.Set(nil)
}
...
func (o *NodeBulkUpdate) SetRackUnitNil() {
	o.RackUnit.Set(nil)
}
...
func (o NodeBulkUpdate) MarshalJSON() ([]byte, error) {
...
func (o NodeBulkUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *NodeBulkUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeBulkUpdate := _NodeBulkUpdate{}

	err = json.Unmarshal(data, &varNodeBulkUpdate)

	if err != nil {
		return err
	}

	*o = NodeBulkUpdate(varNodeBulkUpdate)
...
type NullableNodeBulkUpdate struct {
	value *NodeBulkUpdate
	isSet bool
}

func (v NullableNodeBulkUpdate) Get() *NodeBulkUpdate {
	return v.value
}

func (v *NullableNodeBulkUpdate) Set(val *NodeBulkUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeBulkUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeBulkUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeBulkUpdate(val *NodeBulkUpdate) *NullableNodeBulkUpdate {
	return &NullableNodeBulkUpdate{value: val, isSet: true}
}

func (v NullableNodeBulkUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeBulkUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
