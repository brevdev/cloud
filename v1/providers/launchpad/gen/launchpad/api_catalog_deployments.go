...
/*
V1CatalogDeploymentsInstancesList 🚧 [Beta Feature]
...
type ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest struct {
	ctx                       context.Context
	ApiService                *CatalogDeploymentsAPIService
	id                        string
	deploymentPipelineTrigger *DeploymentPipelineTrigger
}

func (r ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest) DeploymentPipelineTrigger(deploymentPipelineTrigger DeploymentPipelineTrigger) ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest {
	r.deploymentPipelineTrigger = &deploymentPipelineTrigger
	return r
}

func (r ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest) Execute() (*DeploymentPipelineTrigger, *http.Response, error) {
	return r.ApiService.V1CatalogDeploymentsPipelinesTriggerCreateExecute(r)
}

/*
V1CatalogDeploymentsPipelinesTriggerCreate Method for V1CatalogDeploymentsPipelinesTriggerCreate

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest
*/
func (a *CatalogDeploymentsAPIService) V1CatalogDeploymentsPipelinesTriggerCreate(ctx context.Context, id string) ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest {
	return ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
//
//	@return DeploymentPipelineTrigger
func (a *CatalogDeploymentsAPIService) V1CatalogDeploymentsPipelinesTriggerCreateExecute(r ApiV1CatalogDeploymentsPipelinesTriggerCreateRequest) (*DeploymentPipelineTrigger, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeploymentPipelineTrigger
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CatalogDeploymentsAPIService.V1CatalogDeploymentsPipelinesTriggerCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/catalog/deployments/{id}/pipelines/trigger/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.deploymentPipelineTrigger == nil {
		return localVarReturnValue, nil, reportError("deploymentPipelineTrigger is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.deploymentPipelineTrigger
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["TokenAuthentication"]; ok {
...
/*
V1CatalogDeploymentsStatsRetrieve 🚧 [Beta Feature]
...
/*
V1CatalogDeploymentsTasksCreate 🚧 [Beta Feature]
...
/*
V1CatalogDeploymentsTasksList 🚧 [Beta Feature]
...
/*
V1CatalogDeploymentsTasksRetrieve 🚧 [Beta Feature]
