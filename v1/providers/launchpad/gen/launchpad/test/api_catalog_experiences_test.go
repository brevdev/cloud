...
func Test_openapi_CatalogExperiencesAPIService(t *testing.T) {
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesCreate", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var experienceId string

		resp, httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesCreate(context.Background(), experienceId).Execute()
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesDestroy", func(t *testing.T) {
		...
		httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesDestroy(context.Background(), experienceId, id).Execute()
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesList", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var experienceId string

		resp, httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesList(context.Background(), experienceId).Execute()
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesPartialUpdate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesPartialUpdate(context.Background(), experienceId, id).Execute()
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesRetrieve", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesRetrieve(context.Background(), experienceId, id).Execute()
	...
	t.Run("Test CatalogExperiencesAPIService V1CatalogExperiencesNotesUpdate", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.CatalogExperiencesAPI.V1CatalogExperiencesNotesUpdate(context.Background(), experienceId, id).Execute()
