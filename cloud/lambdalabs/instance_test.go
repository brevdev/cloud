...
import (
	...
	"github.com/brevdev/sdk/internal/collections"
)
...
func TestLambdaLabsClient_CreateInstance_Success(t *testing.T) {
	...
	args := cloud.CreateInstanceAttrs{
	...
	assert.Equal(t, cloud.LifecycleStatusRunning, instance.Status.LifecycleStatus)
}
...
func TestLambdaLabsClient_GetInstance_Success(t *testing.T) {
	...
	instance, err := client.GetInstance(context.Background(), cloud.CloudProviderInstanceID(instanceID))
	require.NoError(t, err)
	assert.Equal(t, instanceID, string(instance.CloudID))
...
func TestLambdaLabsClient_GetInstance_NotFound(t *testing.T) {
	...
	_, err := client.GetInstance(context.Background(), cloud.CloudProviderInstanceID(instanceID))
	assert.Error(t, err)
}
...
func TestLambdaLabsClient_ListInstances_Success(t *testing.T) {
	...
	instances, err := client.ListInstances(context.Background(), cloud.ListInstancesArgs{})
	require.NoError(t, err)
...
func TestLambdaLabsClient_ListInstances_Error(t *testing.T) {
	...
	_, err := client.ListInstances(context.Background(), cloud.ListInstancesArgs{})
	assert.Error(t, err)
}
...
func TestLambdaLabsClient_TerminateInstance_Success(t *testing.T) {
	...
	err := client.TerminateInstance(context.Background(), cloud.CloudProviderInstanceID(instanceID))
...
func TestLambdaLabsClient_RebootInstance_Success(t *testing.T) {
	...
	err := client.RebootInstance(context.Background(), cloud.CloudProviderInstanceID(instanceID))
	assert.NoError(t, err)
}
