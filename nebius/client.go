...
var _ cloud.CloudCredential = &NebiusCredential{}
...
func (c *NebiusCredential) GetAPIType() cloud.APIType {
	return cloud.APITypeLocational // Nebius uses location-specific endpoints
}

// GetCloudProviderID returns the cloud provider ID for Nebius
func (c *NebiusCredential) GetCloudProviderID() cloud.CloudProviderID {
	return "nebius"
}
...
func (c *NebiusCredential) MakeClient(ctx context.Context, location string) (cloud.CloudClient, error) {
...
var _ cloud.CloudClient = &NebiusClient{}
...
// GetAPIType returns the API type for Nebius
func (c *NebiusClient) GetAPIType() cloud.APIType {
	return cloud.APITypeLocational
}

// GetCloudProviderID returns the cloud provider ID for Nebius
func (c *NebiusClient) GetCloudProviderID() cloud.CloudProviderID {
	return "nebius"
}

// MakeClient creates a new client instance for a different location
func (c *NebiusClient) MakeClient(ctx context.Context, location string) (cloud.CloudClient, error) {
	return NewNebiusClient(ctx, c.refID, c.serviceAccountKey, c.projectID, location)
}
