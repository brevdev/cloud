...
import (
	...
	openapi "github.com/brevdev/cloud/internal/gen/shadeform"
...
func (c *ShadeformClient) CreateInstance(ctx context.Context, attrs cloud.CreateInstanceAttrs) (*cloud.Instance, error) { //nolint:gocyclo,funlen // ok
	...
	shadeformCloud, shadeInstanceType, err := c.getShadeformCloudAndInstanceType(attrs.InstanceType)
	if err != nil {
		return nil, err
	}

	shadeformCloudEnum, err := openapi.NewCloudFromValue(shadeformCloud)
	if err != nil {
		return nil, err
	}
	...
	createdInstance, err := c.GetInstance(authCtx, cloud.CloudProviderInstanceID(resp.Id))
	if err != nil {
		return nil, err
	}
...
func (c *ShadeformClient) GetInstance(ctx context.Context, instanceID cloud.CloudProviderInstanceID) (*cloud.Instance, error) {
	authCtx := c.makeAuthContext(ctx)
...
func (c *ShadeformClient) TerminateInstance(ctx context.Context, instanceID cloud.CloudProviderInstanceID) error {
	authCtx := c.makeAuthContext(ctx)
...
func (c *ShadeformClient) ListInstances(ctx context.Context, _ cloud.ListInstancesArgs) ([]cloud.Instance, error) {
	authCtx := c.makeAuthContext(ctx)
...
func (c *ShadeformClient) RebootInstance(_ context.Context, _ cloud.CloudProviderInstanceID) error {
	return cloud.ErrNotImplemented
}

func (c *ShadeformClient) MergeInstanceForUpdate(currInst cloud.Instance, _ cloud.Instance) cloud.Instance {
	return currInst
}

func (c *ShadeformClient) MergeInstanceTypeForUpdate(currIt cloud.InstanceType, _ cloud.InstanceType) cloud.InstanceType {
	return currIt
}

func (c *ShadeformClient) getLifecycleStatus(status string) cloud.LifecycleStatus {
...
func (c *ShadeformClient) convertInstanceInfoResponseToV1Instance(instanceInfo openapi.InstanceInfoResponse) (*cloud.Instance, error) {
	...
	instance := &cloud.Instance{
		...
		CloudID:      cloud.CloudProviderInstanceID(instanceInfo.Id),
...
func (c *ShadeformClient) convertShadeformInstanceToV1Instance(shadeformInstance openapi.Instance) (*cloud.Instance, error) {
	...
	instance := &cloud.Instance{
		...
		CloudID:      cloud.CloudProviderInstanceID(shadeformInstance.Id),
...
func (c *ShadeformClient) convertShadeformTagToV1Tag(shadeformTags []string) (cloud.Tags, error) {
	tags := cloud.Tags{}
