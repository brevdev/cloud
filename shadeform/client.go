...
var _ cloud.CloudCredential = &ShadeformCredential{}
...
func (c *ShadeformCredential) GetAPIType() cloud.APIType {
	return cloud.APITypeGlobal
}

// GetCloudProviderID returns the cloud provider ID for Shadeform
func (c *ShadeformCredential) GetCloudProviderID() cloud.CloudProviderID {
...
func (c *ShadeformCredential) GetCapabilities(ctx context.Context) (cloud.Capabilities, error) {
...
func (c *ShadeformCredential) MakeClient(_ context.Context, _ string) (cloud.CloudClient, error) {
...
// GetAPIType returns the API type for Shadeform
func (c *ShadeformClient) GetAPIType() cloud.APIType {
	return cloud.APITypeGlobal
}

// GetCloudProviderID returns the cloud provider ID for Shadeform
func (c *ShadeformClient) GetCloudProviderID() cloud.CloudProviderID {
	return CloudProviderID
}

// MakeClient creates a new client instance
func (c *ShadeformClient) MakeClient(_ context.Context, _ string) (cloud.CloudClient, error) {
	return c, nil
}
